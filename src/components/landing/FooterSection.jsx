...
export function FooterSection() {
  return (
    <footer className="bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl p-2.5 shadow-lg">
                  <svg
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm text-gray-400 hover:text-amber-400 transition-colors duration-300">
            ...
            <ul className="space-y-3">
              {footerLinks.company.links.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-sm text-gray-400 hover:text-amber-400 transition-all duration-300 inline-flex items-center gap-2 group"
                  >
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      ...
                      className="group bg-white/5 hover:bg-gradient-to-br hover:from-amber-500 hover:to-amber-600 rounded-lg p-2.5 transition-all duration-300 hover:scale-110 hover:rotate-3"
                    >
